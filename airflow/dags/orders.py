...
#                '--class', 'Driver.MainApp',
                ...
                '--executor-memory', '3g',
                '--executor-cores', '2',
                '--py-files','s3://shawn-for-spark/orders.zip', 's3://shawn-for-spark/workflow_entry.py',
#                's3://<your_bucket>/spark-engine_2.12-0.01.jar',
                '-p', "{'input_path': 's3://mydata-convert/landing/orders.csv', 'name':'jerseyOrders', 'file_type':'txt', 'output_path': 's3://mydata-convert/orders/', 'partition_column':'player_option'}"
#                '-o', 'parquet',
#                '-p', 'midterm-project',
#                '-i', 'Csv',
